...
function deletarContatosDB() {
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            jQuery.ajax({
                url: '/cadastros/orm/contatoControler.php',
                data: { 'modulo': 'ContatoModel', 'operacao': 'deleteContato', 'idContato': contatoDeleteDB },
                type: 'POST',
                async: true,
                dataType: 'json',
...
console.log('iniciou salvarcontatosDB');
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            ...
            jQuery.ajax({
                url: '/cadastros/orm/contatoControler.php',
                data: { 'modulo': 'ContatoModel', 'operacao': 'insertContato', 'contatos': contatosAtivosSinc },
                type: 'POST',
                async: true,
                dataType: 'json',
...
function getContatosDB() {
    ...
    return new Promise((resolve, reject) => {
        ...
        jQuery.ajax({
          url: '/cadastros/orm/contatoControler.php',
          data: { 'modulo': 'contato', 'operacao': 'getcontatosDB', 'dados': contatosDB },
          type: 'POST',
          async: true,
          dataType: 'json',
