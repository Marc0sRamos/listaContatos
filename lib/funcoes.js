...
function exibirMensagemContatoSalvo(mensagem) {
...
function getNomeCidade(ibge) {
    var arrayMunicipio  = municipiosBaseRemota
...
function ButtonRemoverInput() {
    let idTelefone = criarInput()
